...
Renderer.create = function( scene, canvas ) {
    ...
    Renderer._renderer = new THREE.WebGLRenderer( { canvas:canvas, antialias: true, preserveDrawingBuffer: true, alpha:true} );
    ...
    Renderer._renderer.setClearColor(0x000000, 0);
